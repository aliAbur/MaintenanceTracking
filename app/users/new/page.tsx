  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6 animate-in fade-in duration-500">
      <div className="flex items-center gap-2 text-on-surface-variant text-sm">
        ...
        <span className="text-on-surface font-semibold">Add New User</span>
      </div>

      <div className="flex flex-col gap-1">
        <h2 className="text-3xl font-bold text-on-surface">Add New User</h2>
        <p className="text-base text-on-surface-variant">Create a new account and configure their access permissions.</p>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 border-b border-outline-variant/50 pb-8">
            ...
            <div className="md:w-2/3 flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input required className={inputClasses} id="fullName" name="fullName" placeholder="Jane Doe" type="text" />
              </div>
              <div className="flex flex-col md:flex-row gap-5">
                <div className="flex flex-col gap-2 flex-1">
                  ...
                  <input required className={inputClasses} id="email" name="email" placeholder="jane.doe@example.com" type="email" />
                </div>
                <div className="flex flex-col gap-2 flex-1">
                  <label className="text-xs font-semibold text-on-surface uppercase tracking-wide" htmlFor="phone">Phone Number</label>
                  <input className={inputClasses} id="phone" name="phone" placeholder="+1 (555) 000-0000" type="tel" />
                </div>
              </div>
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <label className="relative flex flex-col p-4 rounded-xl border border-outline-variant/50 cursor-pointer hover:border-primary transition-colors bg-surface-container-lowest has-[:checked]:border-primary has-[:checked]:bg-primary-container/5 has-[:checked]:ring-1 has-[:checked]:ring-primary group">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <input className="text-primary focus:ring-primary w-4 h-4 cursor-pointer" name="role" type="radio" value="Admin" />
                    </div>
                  ...
                  <label className="relative flex flex-col p-4 rounded-xl border border-outline-variant/50 cursor-pointer hover:border-primary transition-colors bg-surface-container-lowest has-[:checked]:border-primary has-[:checked]:bg-primary-container/5 has-[:checked]:ring-1 has-[:checked]:ring-primary group">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <input defaultChecked className="text-primary focus:ring-primary w-4 h-4 cursor-pointer" name="role" type="radio" value="Employee" />
                    </div>
                  ...
                  <label className="relative flex flex-col p-4 rounded-xl border border-outline-variant/50 cursor-pointer hover:border-primary transition-colors bg-surface-container-lowest has-[:checked]:border-primary has-[:checked]:bg-primary-container/5 has-[:checked]:ring-1 has-[:checked]:ring-primary group">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <input className="text-primary focus:ring-primary w-4 h-4 cursor-pointer" name="role" type="radio" value="Observer" />
                    </div>
